# Generated by Powerlevel10k configuration wizard on 2025-09-04 at 15:50 CEST.
...
() {
  ...
  # Context format when running with privileges: hostname only.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%m'
  # Context format when in SSH without privileges: hostname only.
