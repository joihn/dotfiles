...
# ho my zsh
ZSH="$HOME/.oh-my-zsh" SHELL="$HOME/.local/bin/zsh" sh -c "$(curl --proto '=https' --tlsv1.2 -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)" -- --unattended
